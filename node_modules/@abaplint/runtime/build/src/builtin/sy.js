...
exports.sy = new types_1.Structure({
    ...
    mandt: new types_1.Character(3, { qualifiedName: "SY-MANDT", ddicName: "MANDT" }).set("123"),
    ...
    zonlo: new types_1.Character(6).set("UTC"),
    uname: new types_1.Character(12, { qualifiedName: "SY-UNAME", ddicName: "UNAME" }).set("USERNAME"),
